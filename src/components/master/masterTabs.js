...
export const masterTabs = [
  {
    ...
    label: 'Proyek',
    icon: Briefcase,
    description: 'Master proyek untuk transaksi, absensi, dan tarif upah.',
    stateKey: 'projects',
  ...
  },
  {
    ...
    label: 'Pekerja',
    icon: Users,
    description: 'Master pekerja dan relasi upah per proyek.',
    stateKey: 'workers',
  ...
  },
  {
    ...
    label: 'Supplier',
    icon: Truck,
    description: 'Supplier material, operasional, dan lainnya.',
    stateKey: 'suppliers',
  ...
  },
  {
    ...
    label: 'Kategori',
    icon: ClipboardList,
    description: 'Kategori biaya sesuai hasil audit migrasi.',
    stateKey: 'categories',
  ...
  },
  {
    ...
    label: 'Kreditur',
    icon: Landmark,
    description: 'Daftar pemberi pinjaman atau sumber modal.',
  ...
  },
  {
    ...
    label: 'Profesi',
    icon: Wallet,
    description: 'Profesi pekerja untuk kebutuhan klasifikasi dan pencarian.',
  ...
  },
  {
    ...
    label: 'Staf',
    icon: Boxes,
    description: 'Master staf inti dan skema fee per termin.',
